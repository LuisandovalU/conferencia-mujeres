...
/**
 * Componente HeroSection que sirve como el punto de entrada principal del sitio web.
 * Destaca por una tipografía de gran tamaño, información de la fecha y ondas SVG decorativas.
 * 
...
export function HeroSection() {
    return (
        <header className="min-h-screen flex flex-col overflow-hidden pt-20 relative items-center justify-center">
            {/* Contenedor de Contenido Principal: Centrado vertical y horizontalmente */}
            <div className="z-10 -mt-20 text-center max-w-5xl mx-auto px-4 relative space-y-4">
                {/* Etiqueta Superior: Identifica el año del evento */}
                <p className="font-serif italic text-coffee-light text-xl md:text-2xl animate-fade-up">
                    conferencia de mujeres 2025
                </p>

                {/* Título Principal de Marca con animaciones escalonadas para fluidez visual */}
                ...
                {/* Badge con el horario del evento */}
            ...
            {/* Capa Decorativa de Fondo: Ondas SVG de múltiples capas para crear profundidad visual */}
            {/* Se utiliza preserveAspectRatio="none" para que las ondas ocupen todo el ancho sin deformarse visualmente en exceso */}
            <div className="absolute bottom-0 left-0 w-full leading-[0] z-0 overflow-hidden">
                <svg
                    className="w-full h-auto min-h-[200px] md:min-h-[350px] transform-gpu"
                    viewBox="0 0 1440 320"
                    xmlns="http://www.w3.org/2000/svg"
                    preserveAspectRatio="none"
                >
                    {/* Capa 4 (Más lejana / Más clara) */}
                    <path
                        fill="#BCA89A"
                        fillOpacity="0.4"
            ...
            {/* Indicador de desplazamiento animado (Bounce) */}
