...
/**
 * Componente AgendaSection que muestra el horario de los eventos.
 * Itera a través de una lista de elementos para renderizar una línea de tiempo de actividades.
 * 
 * @returns {JSX.Element} La sección de agenda renderizada.
 */
export function AgendaSection() {
    return (
        <section id="agenda" className="py-24 bg-white border-y border-beige-200 overflow-hidden">
            <div className="max-w-5xl mx-auto px-6">
                {/* Cabecera con línea decorativa y fecha del evento */}
                ...
                {/* Lista de actividades mapeadas desde agendaItems con animaciones escalonadas */}
                <div className="grid gap-4">
                    {agendaItems.map((item, index) => (
                        <div
                            key={item.time}
                            className="group grid md:grid-cols-[140px_1fr_auto] gap-6 p-6 rounded-2xl border border-beige-100 hover:border-coffee-dark hover:bg-beige-50 transition-all items-center animate-fade-up"
                        ...
                        >
                            ...
                            {/* Contenido: Título, Conferencista (si aplica) y Descripción */}
                            <div>
                                {item.isKeynote && (
