...
/**
 * AgendaSection component that displays the schedule of events.
 * Iterates through a list of items to render a timeline of activities.
 * 
 * @returns {JSX.Element} The rendered agenda section.
 */
export function AgendaSection() {
    return (
        <section id="agenda" className="py-24 bg-white border-y border-beige-200">
            <div className="max-w-5xl mx-auto px-6">
                {/* Header with decorative line and event date */}
                ...
                {/* List of activities mapped from agendaItems */}
                <div className="grid gap-4">
                    {agendaItems.map((item) => (
                        ...
                        >
                            ...
                            {/* Content: Title, Speaker (if applicable), and Description */}
                            <div>
                                {item.isKeynote && (
